...
H = log2(N), H - количество информации. N - число возможных вариантов
N = 2^H

i = log(2)N, N - мощность алфавита, i - вес одного символа
I = i*k, i вес одного символа, к количество символов I вес сообщенияы
